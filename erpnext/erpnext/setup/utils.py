...
@frappe.whitelist()
def get_exchange_rate(from_currency=None, to_currency=None, transaction_date=None, args=None):
	if not (from_currency and to_currency):
		# manqala 19/09/2016: Should this be an empty return or should it throw and exception? resuelto en 18/11/2022
		return
