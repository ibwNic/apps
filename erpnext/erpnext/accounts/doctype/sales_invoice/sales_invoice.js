...
frappe.ui.form.on('Sales Invoice', {
	...
	refresh: function(frm) {
		...
		frm.add_custom_button(__("Generar Archivo de Impresión PBS"), function() {
			frappe.call({
				"method": "erpnext.accounts.doctype.sales_invoice.sales_invoice.generador_formato_pbs",
				"type": "GET",
				"args": {
				"name": frm.doc.name,
			...
			window.location.href = "https://ibwni-crm.ibw.com/api/method/erpnext.accounts.doctype.sales_invoice.sales_invoice.generador_formato_pbs?name=" + frm.doc.name
