...
website_context = {
	"favicon": "/assets/erpnext/images/logo.png",
	"splash_image": "/assets/erpnext/images/logo.png",
}
#/data/frappe-bench/sites/assets/erpnext/images/erpnext-logo.png
# nosemgrep
website_route_rules = [
...
scheduler_events = {
	...
	"daily": [
		...
		"erpnext.support.doctype.gestion.gestion.programar_suspensiones_temporales",
		"erpnext.selling.doctype.customer.customer.actualizar_Portafolio",
		"erpnext.accounts.doctype.daily_closing_voucher.daily_closing_voucher.cierre_dealer"
	],
	"daily_long": [
...
default_mail_footer = """
	<span>
		Sent via
		<a class="text-muted" href="https://www.ibw.com.ni" target="_blank">
			IBW - NI
		</a>
	</span>
"""
